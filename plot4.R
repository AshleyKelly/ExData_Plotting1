...
plot4 <- function() {
  ...
  par(mfrow=c(2,2))
  with(power_subset,{
    plot(power_subset$Time,as.numeric(as.character(power_subset$Global_active_power)),type="l",  xlab="",ylab="Global Active Power")  
    plot(power_subset$Time,as.numeric(as.character(power_subset$Voltage)), type="l",xlab="datetime",ylab="Voltage")
    plot(power_subset$Time,power_subset$Sub_metering_1,type="n",xlab="",ylab="Energy sub metering")
    ...
    plot(power_subset$Time,as.numeric(as.character(power_subset$Global_reactive_power)),type="l",xlab="datetime",ylab="Global_reactive_power")
  })
  dev.off()
}
=======
version https://git-lfs.github.com/spec/v1
oid sha256:69edfa8a762a7ad517318b8fbd8e355ed75c93e6919f132ff4a479b3d2f87d0e
size 2969
